...
const ProfileSub = () => {
  ...
  const data = organizationDetails.organizationDetails;
    ...
    <div className="max-h-[600px] overflow-y-auto">
      <main>
        <div className="sticky top-0 z-50">
          ...
          <div className="relative -top-20 ms-16 z-10">
            <img
              src={`https://employe-tango-backend.onrender.com/${logo}`}
              alt=""
          ...
          <div className="bg-gray-100 -top-48  relative p-3 flex justify-between ">
            <div className="flex gap-10 ">
              <div className="ms-60">
                <h1 className="text-1xl font-semibold font-poppins">
        ...
        <section className="px-32 relative -top-36 ">
          ...
          <div className="mt-2 font-poppins mb-32">
            <div className="bg-gray-100 p-4 rounded-lg">
              <h1 className="font-poppins font-semibold text-sm  border-b-2 mb-2">
