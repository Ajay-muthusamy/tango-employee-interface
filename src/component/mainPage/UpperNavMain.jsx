...
const UpperNavMain = () => {
  ...
  const handleSignOut = async () => {
    const employeeEmail = organizationDetails.organizationDetails.email;
    // console.log("upperNavbar", organizationDetails.organizationDetails.email);

    try {
      if (employeeEmail) {
        const repsonse = await axios.post(
          `https://employe-tango-backend.onrender.com/tango/logout/${employeeEmail}`
        );
